---
title: Publishing the Field Guide
date: July 13, 2021
author: 
categories: 
url: https://make.wordpress.org/core/handbook/tutorials/publishing-the-field-guide/
---
...
*   The responses are added into the `But Wait, There is More!` section of the Field Guide as individual bullet items in the format of:
    *   Component Name: Trac Ticket Summary (#Trac-Number).
