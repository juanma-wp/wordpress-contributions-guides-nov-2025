...
author: 
categories: 
url: https://make.wordpress.org/core/handbook/tutorials/working-with-patches/
---
...
[SVN Client or Command Line Interface?](#svn-client-or-command-line-interface)
------------------------------------------------------------------------------
...
[Creating and Applying Patches with Grunt](#creating-and-applying-patches-with-grunt)
-------------------------------------------------------------------------------------
...
### [Apply a patch from the command line](#apply-a-patch-from-the-command-line)
...
### [Upload a patch from the command line](#upload-a-patch-from-the-command-line)
...
[Creating and Applying Patches with TortoiseSVN](#creating-and-applying-patches-with-tortoisesvn)
-------------------------------------------------------------------------------------------------
...
### [Creating a Patch with TortoiseSVN](#creating-a-patch-with-tortoisesvn)

#### [1\. Editing/Saving a File](#1-editing-saving-a-file)
...
#### [2\. Creating/Naming a Patch](#2-creating-naming-a-patch)
...
### [Applying a Patch with TortoiseSVN](#applying-a-patch-with-tortoisesvn)

Got a patch you want to test with your local environment? Follow these steps to test your patch.

#### [1\. Downloading a Patch](#1-downloading-a-patch)
...
#### [2\. Applying a Patch with TortoiseSVN](#2-applying-a-patch-with-tortoisesvn)
...
[Creating and Applying Patches with the Command Line](#creating-and-applying-patches-with-the-command-line)
-----------------------------------------------------------------------------------------------------------
...
### [Creating a Patch with the Command Line](#creating-a-patch-with-the-command-line)
...
### [Applying a Patch with the Command Line](#applying-a-patch-with-the-command-line)
...
### [Reverting a Patch with the Command Line](#reverting-a-patch-with-the-command-line)
...
[Download a GitHub pull request](#download-a-github-pull-request)
-----------------------------------------------------------------
