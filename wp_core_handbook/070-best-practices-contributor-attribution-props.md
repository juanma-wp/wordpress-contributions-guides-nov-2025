---
title: Contributor Attribution (“Props”)
date: January 31, 2024
author: 
categories: 
url: https://make.wordpress.org/core/handbook/best-practices/contributor-attribution-props/
---
...
“Props” is short for “proper respect” and is used in WordPress to signify thanks for a contribution. This practice began in [\[1102\]](https://core.trac.wordpress.org/changeset/1102)

#### [Textile checkin. Props to Jaykul for prodding \[…\]](https://core.trac.wordpress.org/changeset/1102)

Changeset #1102

Textile checkin. Props to Jaykul for prodding me into this.

Author: saxmattDate: April 19, 2004

when the first contributor was given props for a contribution to WordPress. Since then, props have been used as a way to recognize and track contributions throughout the project’s history. Contributions to Core take on many forms, from things that directly impact the code (such as writing and reviewing patches) to things like design, testing, and well-written bug reports.

[Who gives props?](#who-gives-props)
------------------------------------
...
Additional non-code contributions are gathered by the Release Squad, and focus leads to be added to the Credits API as necessary. For example, any props given in Slack for helping to test release packages, facilitating meetings, writing developer notes, etc., are currently _not_ automatically compiled.

The Credits API currently only contains contributor lists for WordPress >= 3.2.

[When should props be given?](#when-should-props-be-given)
----------------------------------------------------------
...
[How are props given?](#how-are-props-given)
--------------------------------------------
...
### [wordpress-develop commits in SVN](#wordpress-develop-commits-in-svn)
...
### [GitHub repositories/merge commits](#github-repositories-merge-commits)
...
### [wordpress-develop specific notes](#wordpress-develop-specific-notes)
...
### [GitHub specific notes](#github-specific-notes)
...
### [Major Release Credits](#major-release-credits)
...
*   [https://profiles.wordpress.org/$slack\_user\_id](https://profiles.wordpress.org/$slack_id) will redirect to a contributor’s w.org profile. The Slack ID comes from the details view for a user in Slack (Click on avatar > View full profile > More \[…\] > Copy ID).
...
[Props and About Pages](#props-and-about-pages)
-----------------------------------------------

[Props and Release Announcements](#props-and-release-announcements)
-------------------------------------------------------------------
