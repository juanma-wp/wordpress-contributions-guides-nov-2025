---
title: Installing VVV
date: December 3, 2015
author: 
categories: 
url: https://make.wordpress.org/core/handbook/tutorials/installing-wordpress-locally/installing-vvv/
---
...
[Running a Contributor Day](#running-a-contributor-day)
-------------------------------------------------------
...
### [1\. Downloading VirtualBox](#1-downloading-virtualbox)
...
### [2\. Downloading Vagrant](#2-downloading-vagrant)
...
*   Watch as the script ends, as an administrator or `su` **_password may be required_** to properly modify the hosts file on your local machine.
...
### [5\. Enabling Trunk and The Meta Environment](#5-enabling-trunk-and-the-meta-environment)
...
### [6\. Create a GitHub Repo (optional)](#6-create-a-github-repo-optional)
