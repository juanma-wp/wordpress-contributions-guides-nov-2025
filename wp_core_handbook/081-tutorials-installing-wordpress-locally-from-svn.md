---
title: Installing via SVN
date: July 24, 2013
author: 
categories: 
url: https://make.wordpress.org/core/handbook/tutorials/installing-wordpress-locally/from-svn/
---
...
[Installing WordPress Using Subversion](#installing-wordpress-using-subversion)
-------------------------------------------------------------------------------
...
### [1\. Check Out WordPress Trunk](#1-check-out-wordpress-trunk)

#### [1.1 Using TortoiseSVN](#1-1-using-tortoisesvn)
...
#### [1.2 Using Command Line](#1-2-using-command-line)
...
### [5\. Updating Your Subversion Install](#5-updating-your-subversion-install)
...
#### [5.1 Using TortoiseSVN](#5-1-using-tortoisesvn)
...
#### [5.2 Using Command Line](#5-2-using-command-line)
