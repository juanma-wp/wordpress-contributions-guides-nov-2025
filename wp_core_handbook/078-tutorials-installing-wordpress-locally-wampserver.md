---
title: Installing WampServer
date: March 31, 2013
author: 
categories: 
url: https://make.wordpress.org/core/handbook/tutorials/installing-wordpress-locally/wampserver/
---
...
### [3\. Testing WampServer](#3-testing-wampserver)
...
### [4\. Configuring WampServer](#4-configuring-wampserver)
...
#### [4.1 PHP Configuration](#4-1-php-configuration)
...
#### [4.2 Apache Configuration](#4-2-apache-configuration)
...
### [5\. Creating A MySQL Database With WampServer](#5-creating-a-mysql-database-with-wampserver)
...
### [6\. Shutting Down WampServer](#6-shutting-down-wampserver)
