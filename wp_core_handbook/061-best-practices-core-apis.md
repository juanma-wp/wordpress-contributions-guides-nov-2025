...
[Why You Should Use The Core APIs](#why-you-should-use-the-core-apis)
---------------------------------------------------------------------
...
[WordPress Core APIs](#wordpress-core-apis)
-------------------------------------------
...
### [Dashboard Widgets API](#dashboard-widgets-api)
...
### [Theme Modification API](#theme-modification-api)
...
### [XML-RPC WordPress API](#xml-rpc-wordpress-api)
