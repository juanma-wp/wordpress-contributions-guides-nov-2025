...
author: 
categories: 
url: https://make.wordpress.org/core/handbook/tutorials/installing-wordpress-locally/mamp/
---
...
### [1\. Downloading MAMP](#1-downloading-mamp)
...
### [2\. Installing MAMP](#2-installing-mamp)
...
### [3\. Starting MAMP](#3-starting-mamp)
...
### [4\. Configuring MAMP](#4-configuring-mamp)
...
### [5\. Creating a MySQL Database With MAMP](#5-creating-a-mysql-database-with-mamp)
...
### [6\. Shutting Down MAMP](#6-shutting-down-mamp)
