---
title: Leading Bug Scrubs
date: September 1, 2020
author: 
categories: 
url: https://make.wordpress.org/core/handbook/tutorials/leading-bug-scrubs/
---
...
### [Who can run a Bug Scrub?](#who-can-run-a-bug-scrub)

You! Leading a Bug Scrub is something **any** interested community member can do.

### [What is a Bug Scrub?](#what-is-a-bug-scrub)
...
### [Where do I get a list of tickets for my Bug Scrub?](#where-do-i-get-a-list-of-tickets-for-my-bug-scrub)
...
### [What does it mean to move tickets towards a resolution?](#what-does-it-mean-to-move-tickets-towards-a-resolution)
...
### [How many tickets should be reviewed in a Bug Scrub?](#how-many-tickets-should-be-reviewed-in-a-bug-scrub)
...
### [How do I run a Bug Scrub?](#how-do-i-run-a-bug-scrub)
...
### [What do I need to organize a Bug Scrub?](#what-do-i-need-to-organize-a-bug-scrub)
...
*   An open and collaborative mind set.

You don’t need to:

*   be a core committer or someone that would be called a “core dev” (whatever that means) to lead a Bug Scrub.
*   be a developer at all. Designers, project managers, QA engineers, and product managers can be great Bug Scrub leaders.
*   have the ability to make `/here` announcements in the channel you are running a scrub.
*   have the ability to change the milestone of a ticket.
...
### [I want to lead one, what do I need to do?](#i-want-to-lead-one-what-do-i-need-to-do)

Awesome! Thank you!

You are welcome to schedule a scrub at any time. You will get the most attendees by ensuring it is announced and publicized in advance. There are a few ways to accomplish this:

*   Ping the Core Triage lead for the current release
*   Announce the scrub during the Core Dev chat open floor time
*   Share the scrub on the Core Dev chat agenda/summary posts if you cannot make Core Dev chat

If you plan to organize multiple scrubs, drafting a post to announce the schedule on the Make Core blog is another great way to share (posting on the blog is covered in the [Post & Comment Guidelines](https://make.wordpress.org/core/handbook/best-practices/post-comment-guidelines/#getting-access-to-post)). Scrubs that will reoccur at a regular interval can also be added to the [Meeting Calendar](https://make.wordpress.org/meetings/).
...
### [What should I do if a ticket won’t realistically get completed in its “milestoned” release?](#what-should-i-do-if-a-ticket-wont-realistically-get-completed-in-its-milestoned-release)
...
### [What if no one else shows up?](#what-if-no-one-else-shows-up)
...
_This page is a modified version of the [Bug Scrubs for 4.7](https://make.wordpress.org/core/2016/08/25/bug-scrubs-for-4-7/) post on [Making WordPress Core](https://make.wordpress.org/core/). Props to @jorbin for writing that post._