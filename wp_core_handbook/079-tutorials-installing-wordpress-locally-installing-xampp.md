...
author: 
categories: 
url: https://make.wordpress.org/core/handbook/tutorials/installing-wordpress-locally/installing-xampp/
---
...
### [1\. Downloading XAMPP](#1-downloading-xampp)
...
### [3\. Starting XAMPP](#3-starting-xampp)
...
### [4\. Configuring XAMPP](#4-configuring-xampp)
...
### [5\. Securing Your XAMPP Install](#5-securing-your-xampp-install)
...
### [6\. Creating a MySQL Database With XAMPP](#6-creating-a-mysql-database-with-xampp)
...
### [7\. Shutting Down XAMPP](#7-shutting-down-xampp)
