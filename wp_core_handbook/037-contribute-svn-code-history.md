---
title: Researching Code History
date: July 15, 2012
author: 
categories: 
url: https://make.wordpress.org/core/handbook/contribute/svn/code-history/
---

[Using Subversion Annotate](#using-subversion-annotate)
-------------------------------------------------------
...
[Anatomy Of A Changeset](#anatomy-of-a-changeset)
-------------------------------------------------
...
*   Message – Why the change was made. Often, this includes any associated trac tickets (e.g. [#12345](https://core.trac.wordpress.org/ticket/12345)
    
    #### [Reposition Loading Spinner for Quick Edit to sit next to "Update Post" button](https://core.trac.wordpress.org/ticket/12345)
    
    Ticket #12345
    
    The Loading Spinner for Quick Edit currently sits next to the cancel button. It makes more sense to reposition it next to the "Update Post" button since it's more closely tied to and triggered by that button. (Cancel does not trigger t \[…\]
    
    ##### Last 2 Comments
    
    *   prbot — 5:17 am on March 11, 2025
        
        *   **keywords** _has-patch_ added
        
        _This ticket was mentioned in <a class="ext-link" href="https://github.com/WordPress/wordpress-develop/p \[…\]_
        
    *   slackbot — 7:10 pm on September 14, 2022
        
        _This ticket was mentioned in [​Slack](https://make.wordpress.org/chat/) in #core by hellofromtonya. <a class="ext-link" href="https://wordpress.slack.com/archives/core/p16631825 \[…\]_
        
    
    Owner: nacinType: defect (bug)Status: closedComponent: UISeverity: trivialUpdated: 8 months ago
    
    ), associated unit test tickets (e.g. #UT12345), and the user who wrote the accepted patch (e.g. props username).
*   Changed files – A list of added and removed files, and an inline diff of modified files.

[Associating Code With A WordPress Release](#associating-code-with-a-wordpress-release)
---------------------------------------------------------------------------------------
