...
In order to contribute to WordPress core, you need a local development environment and a checkout of WordPress trunk, which is the development version of WordPress. Be aware that this is _not_ the same as the latest downloadable WordPress release.
...
### [Setting up a version control system](#setting-up-a-version-control-system)
...
### [Setting up the WordPress development repository](#setting-up-the-wordpress-development-repository)
