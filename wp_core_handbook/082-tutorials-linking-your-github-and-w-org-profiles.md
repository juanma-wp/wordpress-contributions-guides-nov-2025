---
title: Linking your GitHub and w.org profiles
date: January 31, 2024
author: 
categories: 
url: https://make.wordpress.org/core/handbook/tutorials/linking-your-github-and-w-org-profiles/
---
...
[How to connect your accounts](#how-to-connect-your-accounts)
=============================================================
...
### [1\. Log in to WordPress.org and edit profile](#1-log-in-to-wordpress-org-and-edit-profile)
...
### [2\. Authorize WordPress.org Profiles application](#2-authorize-wordpress-org-profiles-application)
...
### [4\. Add your WordPress.org Git email to your GitHub email list](#4-add-your-wordpress-org-git-email-to-your-github-email-list)
...
[How do I know if my accounts are connected?](#how-do-i-know-if-my-accounts-are-connected)
------------------------------------------------------------------------------------------

There are a few other ways to check whether your accounts are connected.

### [Check your w.org profile](#check-your-w-org-profile)
...
### [Check for a w.org redirect](#check-for-a-w-org-redirect)
...
### [Check against the w.org API](#check-against-the-w-org-api)
