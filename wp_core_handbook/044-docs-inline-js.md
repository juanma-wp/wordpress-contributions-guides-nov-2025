...
author: 
categories: 
url: https://make.wordpress.org/core/handbook/docs/inline/js/
---
...
*   Create a [new ticket](https://core.trac.wordpress.org/newticket) on Core Trac for the file:
    *   Suggested _Title_ formats could be “JSDoc correction for path/to/file.js” or “Improve documentation for path/to/file.js”.
    *   The _Type_ should be **defect (bug)**.
    *   Assign the ticket to the _Component_ the file is associated with.
    *   Leave the _Version_ blank.
    *   Add the **docs** and the **JavaScript** _Focus_ by clicking on it.
