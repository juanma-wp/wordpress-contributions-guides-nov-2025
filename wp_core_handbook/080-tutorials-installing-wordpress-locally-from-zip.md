...
author: 
categories: 
url: https://make.wordpress.org/core/handbook/tutorials/installing-wordpress-locally/from-zip/
---
...
You can check what version you’re using either on the **Dashboard**, or by checking the footer of any admin page (_You are using a development version (3.8-alpha). Cool! Please stay updated._).
